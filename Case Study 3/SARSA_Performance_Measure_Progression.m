...
for outer_Cntr = 1:1:200 %30
    ...
    % hypervolumes.  Each hypervolume is denoted by "action_value".
    ...
    dActions = linspace(33,66,actionResAvailable)';
    ...
    if outer_Cntr == 1
        ...
        %% Correction of flag 2021-08-12
        for inner_Cntr = 1:1:flag*instances_per_update
            Reps.action_value = Reps.action_value + out_Reps(inner_Cntr).action_value;
        end
    else%if mod(instances_per_update,outer_Cntr) == 0
        prevFlag = flag;
        flag = flag + 1;
        for inner_Cntr = prevFlag*instances_per_update:1:flag*instances_per_update
            Reps.action_value = Reps.action_value + out_Reps(inner_Cntr).action_value;
        end
    end
    ...
    STATS.Rewards = sum( cell2mat(learning_sim.agentExp{1, 1}(:,5)));
    ...
    function [learning,Reps] = train_agent(par,training,rvTwo,rvOne,...
            ...
            for stepCntr = 1:1:training.nmberOfSteps
                ...
                if State(currentTimeStamp) ~= myEnvironment.Terminal &&...
                    ...
                    MV_high_bound = 100; % upper bound of MV
