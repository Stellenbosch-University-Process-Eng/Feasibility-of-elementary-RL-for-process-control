...
actionResAvailable = 6;%5;       % actions available = (actionResAvailable - 1)
...
startingCoordinate = [par.XmwSS,par.XmsSS,par.XmfSS,par.XmrSS,par.XmbSS,...
                   par.XswSS,par.XssSS,par.XsfSS,par.IntErrSS]';
...
delete(p) % shut down parallel pool
...
function [nxtModelCoordinate,nxtPSE] = simulateMDP(currentTimeStamp,...
                                       crntModelCoordinate,...
                                       a,par,disturbanceValue_1,disturbanceValue_2)
    ...
    nxtModelCoordinate = [nxtXmw,nxtXms,nxtXmf,nxtXmr,nxtXmb,nxtXsw,nxtXss,nxtXsf,nxtIntErr]';
