...
%% S = [E(T),DV,SP]'; A = x;
%% NOTE:  Example graphs in appendix A was generated by running the 3000 episodes and then running a further 1380 episodes with the stored
%% approximate action-values saved after the first 3000 episodes.  Afterwards, the final policy was tested by introducing a step
%% change in the inlet flow rate.  Similar numbers of training episodes will yield qualitatively similar results.
%% 
clc
clear
clf
