%% script for training SARSA-LPF controller on VdV reaction environment with 
%% functionality for sampling SP and DV changes from normal distribution.
%% Similar to VdV_ss_SARSA_LPF_generator.m, but allows for parameter uncertainty 
%% runs and intervals of 40 seconds between agent action selection allowed.
%% Note:  Normal distrubution should be replaced by sampling from an
%% appropriately scaled uniform distribution, as discussed with the student 
%% during the relevant meeting.
%% Name: seconds_VdV_ss_SARSA_LPF_generato_FF.m
%% Date: before 2020-10-22
clc
%clear
