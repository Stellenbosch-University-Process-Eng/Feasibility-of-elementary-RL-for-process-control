%% Script to run instances of discretization fineness for the Van der Vusse
%% control problem.
%% NOTES: Parallel computation used.  Fineness of discretization must be set manually for a run.
tic
%%
%% 
...
numError_intervals = 2;
numInletT_intervals = 2;
numSP_intervals = 11;
numAction_intervals = 6; 
